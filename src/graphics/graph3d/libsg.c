...
void calc_skinned_position(sceVu0FVECTOR dp, sceVu0FVECTOR *v)
{
    ...
    vf13[0] = (m0[0][0] * v[0][0]) + (m0[1][0] * v[0][1]) + (m0[2][0] * v[0][2]) + m0[3][0];
    vf13[1] = (m0[0][1] * v[0][0]) + (m0[1][1] * v[0][1]) + (m0[2][1] * v[0][2]) + m0[3][1];
    vf13[2] = (m0[0][2] * v[0][0]) + (m0[1][2] * v[0][1]) + (m0[2][2] * v[0][2]) + m0[3][2];
    vf13[3] = 1.0f - v[0][3];

    vf14[0] = (m1[0][0] * v[1][0]) + (m1[1][0] * v[1][1]) + (m1[2][0] * v[1][2]) + m1[3][0];
    vf14[1] = (m1[0][1] * v[1][0]) + (m1[1][1] * v[1][1]) + (m1[2][1] * v[1][2]) + m1[3][1];
    vf14[2] = (m1[0][2] * v[1][0]) + (m1[1][2] * v[1][1]) + (m1[2][2] * v[1][2]) + m1[3][2];
...
void Vu0ApplyVectorInline(sceVu0FVECTOR v0, sceVu0FVECTOR v1)
{
    ...
    v0[0] = (m0[0][0] * v1[0]) + (m0[1][0] * v1[1]) + (m0[2][0] * v1[2]) + (m0[3][0] * 1.0f);
    v0[1] = (m0[0][1] * v1[0]) + (m0[1][1] * v1[1]) + (m0[2][1] * v1[2]) + (m0[3][1] * 1.0f);
    v0[2] = (m0[0][2] * v1[0]) + (m0[1][2] * v1[1]) + (m0[2][2] * v1[2]) + (m0[3][2] * 1.0f);
    v0[3] = (m0[0][3] * v1[0]) + (m0[1][3] * v1[1]) + (m0[2][3] * v1[2]) + (m0[3][3] * 1.0f);
}
